    ...
    if (s) i.adoptedStyleSheets = e.map((t) => (t instanceof CSSStyleSheet ? t : t.styleSheet));
      ...
      for (const s of e) {
        const e = document.createElement("style"),
          o = t.litNonce;
        void 0 !== o && e.setAttribute("nonce", o), (e.textContent = s.cssText), i.appendChild(e);
      }
  },
  c = s
    ? (t) => t
...
class $ extends HTMLElement {
  ...
  C(t, s) {
    ...
    if (void 0 !== e && !0 === i.reflect) {
      ...
      (this.m = t), null == o ? this.removeAttribute(e) : this.setAttribute(e, o), (this.m = null);
    }
  }
  _$AK(t, s) {
  ...
  requestUpdate(t, s, i) {
    if (void 0 !== t) {
      if (((i ??= this.constructor.getPropertyOptions(t)), !(i.hasChanged ?? S)(this[t], s))) return;
      this.T(t, s, i);
    }
  ...
  performUpdate() {
    ...
    if (!this.hasUpdated) {
      ...
      if (t.size > 0)
        for (const [s, i] of t) !0 !== i.wrapped || this._$AL.has(s) || void 0 === this[s] || this.T(s, this[s], i);
    }
    let t = !1;
    const s = this._$AL;
    try {
      (t = this.shouldUpdate(s)),
        t ? (this.willUpdate(s), this.P?.forEach((t) => t.hostUpdate?.()), this.update(s)) : this.k();
    } catch (s) {
      throw ((t = !1), this.k(), s);
    }
    t && this._$AE(s);
...
const X = (t, s) => {
  ...
  for (let s = 0; s < i; s++) {
      ...
      (l = r.lastIndex),
        r === V
          ...
          ? ">" === c[0]
            ...
            : void 0 === c[1]
            ? (a = -2)
            : ((a = r.lastIndex - c[2].length), (n = c[1]), (r = void 0 === c[3] ? j : '"' === c[3] ? H : D))
          : r === H || r === D
          ? (r = j)
          : r === L || r === I
          ? (r = V)
    ...
    h += r === V ? i + k : a >= 0 ? (e.push(n), i.slice(0, a) + x + i.slice(a) + A + u) : i + A + (-2 === a ? s : u);
  }
    ...
    for (; null !== (e = K.nextNode()) && n.length < r; ) {
      if (1 === e.nodeType) {
          ...
          for (const t of e.getAttributeNames())
            if (t.endsWith(x)) {
              ...
              n.push({
                ...
                e.removeAttribute(t);
            } else t.startsWith(A) && (n.push({ type: 6, index: o }), e.removeAttribute(t));
        if (B.test(e.tagName)) {
          const t = e.textContent.split(A),
            s = t.length - 1;
          if (s > 0) {
            e.textContent = C ? C.emptyScript : "";
            for (let i = 0; i < s; i++) e.append(t[i], U()), K.nextNode(), n.push({ type: 2, index: ++o });
            e.append(t[s], U());
          }
        }
        ...
        if (e.data === M) n.push({ type: 2, index: o });
          ...
          let t = -1;
          for (; -1 !== (t = e.data.indexOf(A, t + 1)); ) n.push({ type: 7, index: o }), (t += A.length - 1);
        }
      o++;
    }
  }
...
class it {
  ...
  L(t) {
    this._$AH !== F && N(this._$AH) ? (this._$AA.nextSibling.data = t) : this.j(E.createTextNode(t)), (this._$AH = t);
  }
  I(t) {
  ...
  D(t) {
    ...
    let i,
      e = 0;
    for (const o of t)
      e === s.length ? s.push((i = new it(this.H(U()), this.H(U()), this, this.options))) : (i = s[e]), i._$AI(o), e++;
...
class et {
  ...
  _$AI(t, s = this, i, e) {
    ...
    let h = !1;
    if (void 0 === o) (t = tt(this, t, s, 0)), (h = !N(t) || (t !== this._$AH && t !== Z)), h && (this._$AH = t);
    else {
      const e = t;
      let r, n;
...
class rt extends et {
  ...
  _$AI(t, s = this) {
    ...
    const i = this._$AH,
      e = (t === F && i !== F) || t.capture !== i.capture || t.once !== i.once || t.passive !== i.passive,
      o = t !== F && (i === F || e);
...
const ct = { W: x, q: A, J: M, Z: 1, F: X, G: st, K: R, X: tt, Y: it, tt: et, st: ht, it: rt, et: ot, ot: nt },
